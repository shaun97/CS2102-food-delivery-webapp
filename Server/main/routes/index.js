...
router.post("/api/posts/userprofiletodb", (req, pres, next) => {
  ...
  switch (req.body.userType) {
    case "rider":
      ...
      queryText2 =
        req.body.riderType === "FTRiders"
          ? `INSERT INTO FTRiders(rid) VALUES($1)`
          : `INSERT INTO PTRiders(rid) VALUES($1)`;
      break;
    case "staff":
      ...
      if (res.rowCount !== 0) {
        ...
        const values1 =
          req.body.userType === "staff"
            ? [req.body.selectedRestaurant, res.rows[0].id]
            : [res.rows[0].id];
